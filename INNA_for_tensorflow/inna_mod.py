...
from tensorflow import evaluation
...
class NADIANOptimizer(optimizer.Optimizer):
  """Optimizer that implements the NADIAN algorithm.
  See [Castera et al., 2019](https://arxiv.org/abs/1905.12278).
  """
  ...
  def _apply_dense(self, grad, var):
    ...
    print("grad=",evaluation(tf.print(grad)))
    print("pre_grad=",evaluation(tf.print(pre_g)))
